# 简答题
![Pandao editor.md](https://github.com/752061016/fed-e-task-01-01/image/01.jpg "Pandao editor.md")
## 第1题
### 10
在a\[6]()运行前for循环就执行完毕了，但因为在for中i定义的是全局变量，所以所有的方法都是打印同一个变量i，在循环结束后变为10，所以不管数组内哪个元素打印的都是10

![Pandao editor.md](https://github.com/752061016/fed-e-task-01-01/image/02.jpg "Pandao editor.md")
## 第2题
### 报错 未初始化
if的{}内算块级作用域，因为在内部使用let块级作用域定义了tmp，所以外部的tmp访问不到，块级作用域不会变量提升，所以在访问时还未定义

![Pandao editor.md](https://github.com/752061016/fed-e-task-01-01/image/03.jpg "Pandao editor.md")
## 第3题
```javascript
var arr = [12, 34, 32, 89, 4]
console.log(Math.min(...arr)) // 4
```
![Pandao editor.md](https://github.com/752061016/fed-e-task-01-01/image/04.jpg "Pandao editor.md")
## 第4题
...
![Pandao editor.md](https://github.com/752061016/fed-e-task-01-01/image/05.jpg "Pandao editor.md")
## 第5题
### 20
因为fn的调用者是obj，所以fn内部的this指向为obj，fn内部调用setTimeout(),但因为使用的是箭头函数，this的指向不会发生改变，所以还是this还是指向obj，打印obj.a，输出20


![Pandao editor.md](https://github.com/752061016/fed-e-task-01-01/image/06.jpg "Pandao editor.md")
## 第6题
#### 扩展对象，解决属性名冲突问题
```javascript
const obj = {}
...
```
![Pandao editor.md](https://github.com/752061016/fed-e-task-01-01/image/07.jpg "Pandao editor.md")
## 第7题
...
![Pandao editor.md](https://github.com/752061016/fed-e-task-01-01/image/08.jpg "Pandao editor.md")
## 第8题
...
![Pandao editor.md](https://github.com/752061016/fed-e-task-01-01/image/09.jpg "Pandao editor.md")
## 第9题
...
```
![Pandao editor.md](https://github.com/752061016/fed-e-task-01-01/image/10.jpg "Pandao editor.md")
## 第10题
...
![Pandao editor.md](https://github.com/752061016/fed-e-task-01-01/image/11.jpg "Pandao editor.md")
## 第11题
